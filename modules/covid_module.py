...
4 Classes: COVID-19, Normal, Lung Opacity, Viral Pneumonia
"""
...
def get_model() -> torch.nn.Module:
    """Returns ResNet18 model configured with 4-class classification head."""
...
def get_hospital_partitions(num_hospitals: int = 3, alpha: float = 0.5) -> List[Tuple[DataLoader, DataLoader]]:
    ...
    # Search for dataset files in data/covid/
